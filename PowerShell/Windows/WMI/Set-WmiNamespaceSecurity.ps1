...
Param ( [parameter(Mandatory=$false,Position=0)][string] $namespace = 'root/cimv2',
    [parameter(Mandatory=$false,Position=1)][string] $operation = 'add',
    [parameter(Mandatory=$false,Position=2)][string] $account,
    [parameter(Position=3)][string[]] $permissions = @("Enable","RemoteAccess"),
